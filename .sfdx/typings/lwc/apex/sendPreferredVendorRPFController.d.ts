...
declare module "@salesforce/apex/sendPreferredVendorRPFController.getContactRecord" {
  export default function getContactRecord(param: {recordId: any}): Promise<any>;
}
