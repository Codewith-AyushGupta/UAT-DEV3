({
    ...
    doInit:function(component, event, helper){
        ...
        //fetch data
        helper.fetchPickListValues(component, event, helper,'Preferred_Vendor_RPF__c','State__c');        
        helper.fetchPickListValues(component, event, helper, 'Contact','Department_Service_LT__c');
        helper.fetchPickListValues(component, event, helper, 'Current_Account__c','LT_Account_Type__c');
